...
namespace MonoGame
{
    public static class Primitives2D
    {
        ...
        /// <summary>
        /// Rotate a vector based on an origin
        /// </summary>
        /// <param name="point">The point to rotate</param>
        /// <param name="radians">The angle of the rotation</param>
        /// <param name="origin">The origin of the rotation</param>
        /// <returns>A rotated vector based on the origin</returns>
        private static Vector2 GetRotatedPoint(Vector2 point, float radians, Vector2 origin)
        {
        ...
        /// <param name="origin">The origin of the rotation</param>
        private static void FillRectangle(this SpriteBatch spriteBatch, Rectangle rect, Color color, float angle, Vector2 origin)
        {
            if (pixel == null)
            {
            ...
            Vector2 actualOrigin = new Vector2(origin.X / rect.Width, origin.Y / rect.Height);

            spriteBatch.Draw(pixel, rect, null, color, angle, actualOrigin, SpriteEffects.None, 0);
        }
        ...
        /// <param name="color">The color to draw the rectangle in</param>
        /// <param name="origin">The origin of the rotation</param>
        private static void FillRectangle(this SpriteBatch spriteBatch, Vector2 location, Vector2 size, Color color, float angle, Vector2 origin)
        {
            if (pixel == null)
            {
                CreateThePixel(spriteBatch);
            ...
            Vector2 actualOrigin = new Vector2(origin.X / size.X, origin.Y / size.Y);
        ...
        public static void DrawRectangle(this SpriteBatch spriteBatch, Rectangle rect, Color color, bool fill)
        {
            if (fill)
                FillRectangle(spriteBatch, rect, color, 0f, Vector2.Zero);
            else
        ...
        {
            DrawRectangle(spriteBatch, rect, color, thickness, 0f, Vector2.Zero);
        ...
        {
            DrawRectangle(spriteBatch, rect, color, thickness, angle, Vector2.Zero);
        }
        ...
        /// <param name="angle">The angle of the rotation</param>
        /// <param name="origin">The origin of the rotation</param>
        public static void DrawRectangle(this SpriteBatch spriteBatch, Rectangle rect, Color color, float thickness, float angle, Vector2 origin)
        {

            // TODO: Figure out the pattern for the offsets required and then handle it in the line instead of here

            Vector2 actualOrigin = rect.Location.ToVector2() + origin;

            DrawLine(spriteBatch, GetRotatedPoint(new Vector2(rect.X, rect.Y), angle, actualOrigin) - origin,
                GetRotatedPoint(new Vector2(rect.Right, rect.Y), angle, actualOrigin) - origin, color, thickness); // top

            DrawLine(spriteBatch, GetRotatedPoint(new Vector2(rect.X, rect.Y), angle, actualOrigin) - origin,
                GetRotatedPoint(new Vector2(rect.X, rect.Bottom + thickness), angle, actualOrigin) - origin, color, thickness); // left

            DrawLine(spriteBatch, GetRotatedPoint(new Vector2(rect.X, rect.Bottom), angle, actualOrigin) - origin,
                GetRotatedPoint(new Vector2(rect.Right, rect.Bottom), angle, actualOrigin) - origin, color, thickness); // bottom

            DrawLine(spriteBatch, GetRotatedPoint(new Vector2(rect.Right, rect.Y), angle, actualOrigin) - origin,
                GetRotatedPoint(new Vector2(rect.Right, rect.Bottom + thickness), angle, actualOrigin) - origin, color, thickness); // right
        ...
        /// <param name="color">The color to draw the rectangle in</param>
        /// <param name="fill">If true the rectangle will be filled</param>
        public static void DrawRectangle(this SpriteBatch spriteBatch, Vector2 location, Vector2 size, Color color, bool fill)
        {
            if (fill)
                FillRectangle(spriteBatch, location, size, color, 0f, Vector2.Zero);
            else
        ...
        {
            DrawRectangle(spriteBatch, new Rectangle((int)location.X, (int)location.Y, (int)size.X, (int)size.Y), color, thickness, 0f, Vector2.Zero);
        }
        ...
        {
            DrawRectangle(spriteBatch, new Rectangle((int)location.X, (int)location.Y, (int)size.X, (int)size.Y), color, thickness, angle, Vector2.Zero);
        }
        ...
        /// <param name="angle">The angle of the rotation</param>
        /// <param name="origin">The origin of the rotation</param>
        public static void DrawRectangle(this SpriteBatch spriteBatch, Vector2 location, Vector2 size, Color color, float thickness, float angle, Vector2 origin)
        {
        ...
        /// <param name="angle">The angle of the rotation</param>
        /// <param name="fill">If true the rectangle will be filled</param>
        public static void DrawRectangle(this SpriteBatch spriteBatch, Rectangle rect, Color color, float angle, bool fill)
        {
            if (fill)
                FillRectangle(spriteBatch, rect, color, angle, Vector2.Zero);
            else
                DrawRectangle(spriteBatch, rect, color, 1f, angle, Vector2.Zero);
        }
        ...
        /// <param name="angle">The angle of the rotation</param>
        /// <param name="fill">If true the rectangle will be filled</param>
        public static void DrawRectangle(this SpriteBatch spriteBatch, Rectangle rect, Color color, float angle, Vector2 origin, bool fill)
        {
            if (fill)
                FillRectangle(spriteBatch, rect, color, angle, origin);
            else
                DrawRectangle(spriteBatch, rect, color, 1f, angle, origin);
        }
        ...
        /// <param name="angle">The angle of the rotation</param>
        /// <param name="fill">If true the rectangle will be filled</param>
        public static void DrawRectangle(this SpriteBatch spriteBatch, Vector2 location, Vector2 size, Color color, float angle, bool fill)
        {
            if (fill)
                FillRectangle(spriteBatch, location, size, color, angle, Vector2.Zero);
            else
                DrawRectangle(spriteBatch, new Rectangle((int)location.X, (int)location.Y, (int)size.X, (int)size.Y), color, 1f, angle, Vector2.Zero);
        }
